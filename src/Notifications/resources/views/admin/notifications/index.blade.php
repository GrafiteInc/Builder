                        ...
                        @foreach($notifications as $notification)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-danger btn-xs" href="{!! route('admin.notifications.delete', [$notification->id]) !!}" onclick="return confirm('Are you sure you want to delete this notification?')">
