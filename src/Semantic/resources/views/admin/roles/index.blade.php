                ...
                <tbody>
                    @foreach($roles as $role)
                        <tr>
                            ...
                            <td>{{ $role->label }}</td>
                            <td>
                                <a class="ui button red mini right floated " href="{{ url('admin/roles/'.$role->id.'/delete') }}" onclick="return confirm('Are you sure you want to delete this role?')"><span class="fa fa-edit"></span> Delete</a>
